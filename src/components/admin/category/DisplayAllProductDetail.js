  ...
  const ProductDetailForm = () => {
    return (
      <Grid container spacing={2}>
        ...
        <Grid item xs={4}>
          <FormControl fullWidth>
            <InputLabel>packagingType</InputLabel>
            <Select
              value={packagingType}
        ...
        <Grid item xs={4}>
          <FormControl fullWidth>
            ...
            >
              <MenuItem value="HoliSale">HoliSale</MenuItem>
              <MenuItem value="DiwaliSale">DiwaliSale</MenuItem>
              <MenuItem value="DasheraSale">DasheraSale</MenuItem>
              <MenuItem value="NewYearSale">NewYearSale</MenuItem>
              <MenuItem value="NavratriSale">NavratriSale</MenuItem>
              <MenuItem value="RakshabandhanSale">RakshabandhanSale</MenuItem>
            </Select>
            <FormHelperText>
              <div className={classes.errorMessagestyle}>
        ...
        <Grid item xs={4}>
          <FormControl fullWidth>
            <InputLabel>productStatus</InputLabel>
            <Select
              value={productStatus}
        ...
        <div className={classes.displayBox}>
          <MaterialTable
            ...
            columns={[
              ...
              { title: "ProductDetail Name", field: "productdetailname" },
              { title: "All Data ProdutDetails",
                render: (rowData) => (
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <div>{rowData.weight}{rowData.weighttype}</div>
                    <div>{rowData.packagingtype}</div>
                    <div>{rowData.noofqty}</div>
                    <div>{rowData.stock}</div>
                    <div>{rowData.price}</div>
                    <div>{rowData.offerprice}</div>
                    <div>{rowData.offertype}</div>
                    <div>{rowData.productstatus}</div>
                  </div>
                ),
              },
              {

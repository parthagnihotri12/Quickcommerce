      ...
      >
        ...
        >
          <div style={{ padding: 15 }}>
            <div>
              <img src={"/cross.png"} style={{ width: 20, height: 20 }} />
            </div>
            ...
            >
              Verify Your Mobile Number to <br></br> access your Quickcomm
              Account
            </div>
            <Box
              sx={{ display: "flex", alignItems: "flex-end", marginTop: "5%" }}
            >
            ...
            >
              By Continuing, you agree to our terms and conditions of
